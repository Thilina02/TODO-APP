...
export const TodoItem = ({ todo, onToggle, onEdit, onDelete }: TodoItemProps) => {
  ...
  if (isEditing) {
    return (
      <div className="bg-gradient-to-br from-white to-gray-50 dark:from-gray-800 dark:to-gray-900 rounded-xl p-5 shadow-lg border-2 border-blue-300 dark:border-blue-600 animate-slideIn transform transition-all duration-300">
        <input
          type="text"
          value={editTitle}
  ...
  return (
    <div
      className={`
        rounded-xl p-5 shadow-lg transition-all duration-300 animate-slideIn
      ...
      <div className="flex items-start gap-4">
        ...
        <div className="flex gap-2 flex-shrink-0" onClick={(e) => e.stopPropagation()} onMouseDown={(e) => e.stopPropagation()}>
          <button
            ...
            className="p-2.5 text-blue-600 hover:bg-blue-100 dark:hover:bg-blue-900/40 rounded-lg transition-all duration-200 transform hover:scale-110 active:scale-95 shadow-sm"
          ...
          <button
            ...
            className="p-2.5 text-red-600 hover:bg-red-100 dark:hover:bg-red-900/40 rounded-lg transition-all duration-200 transform hover:scale-110 active:scale-95 shadow-sm"
